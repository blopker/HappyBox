...
var HappyHolder = React.createClass({displayName: "HappyHolder",
	getColor: function() {
	...
	render: function() {
		...
		for (var i = 0; i < 1000; i++) {
			boxes.push(React.createElement(HappyBox, {key: i, color: this.getColor()}))
		};

		return (
			React.createElement("div", {className: "happy-holder", onMouseMove: this.onOver}, boxes)
		);
	}
});

var PureRenderMixin = require('react/addons').PureRenderMixin;
var HappyBox = React.createClass({displayName: "HappyBox",
	...
	render: function() {
		...
		return (
			React.createElement("div", {className: "happy-box", style: style})
		);
	}
});
...
},{"react":175,"react/addons":3}],2:[function(require,module,exports){
