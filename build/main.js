...
let HappyBoxes = React.createClass({
	...
	render: function () {
		...
		return React.createElement(
			'div',
			{ className: 'happy-boxes', onMouseMove: this.onOver },
			boxes
		);
	}
});
...
let HappyBox = props => {
	...
	return React.createElement('div', { className: 'happy-box', style: style });
};

ReactDOM.render(React.createElement(HappyBoxes, null), document.querySelector('.happy-container'));
